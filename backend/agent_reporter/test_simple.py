#!/usr/bin/env python3
"""
Simple test for Agent Reporter
"""
...
def test_reporter():
    """Test the agent reporter with simple portfolio data"""
                    ...
                    "positions": [
                        {
                            ...
                            "instrument": {
                                ...
                                "allocation_sectors": {"technology": 30.0, "healthcare": 15.0, "other": 55.0}
                            }
                        }
                    ]
                }
    ...
    result = reporter_agent(test_payload)
